...
NovoFieldElement.ɵcmp = i0.ɵɵdefineComponent({ type: NovoFieldElement, selectors: [["novo-field"]], contentQueries: function NovoFieldElement_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, directives: [i1.NgSwitch, i1.NgSwitchCase], styles: ["@-webkit-keyframes rotate{0%{transform:rotate(0deg)}75%{transform:rotate(200deg)}to{transform:rotate(180deg)}}@keyframes rotate{0%{transform:rotate(0deg)}75%{transform:rotate(200deg)}to{transform:rotate(180deg)}}@-webkit-keyframes half-rotate{0%{transform:rotate(45deg)}75%{transform:rotate(100deg)}to{transform:rotate(90deg)}}@keyframes half-rotate{0%{transform:rotate(45deg)}75%{transform:rotate(100deg)}to{transform:rotate(90deg)}}@-webkit-keyframes rotateBack{0%{transform:rotate(90deg)}to{transform:rotate(0deg)}}@keyframes rotateBack{0%{transform:rotate(90deg)}to{transform:rotate(0deg)}}@-webkit-keyframes show{0%{opacity:0;transform:translateX(-100%)}75%{transform:translateX(0)}to{opacity:1;transform:translateX(0)}}@keyframes show{0%{opacity:0;transform:translateX(-100%)}75%{transform:translateX(0)}to{opacity:1;transform:translateX(0)}}[_nghost-%COMP%]{display:grid;font-size:1.1rem}.novo-field-appearance-horizontal[_nghost-%COMP%]{grid-gap:0 1rem;grid-template-areas:\"label input\" \". messages\";grid-template-columns:150px minmax(-webkit-min-content,-webkit-max-content);grid-template-columns:150px minmax(min-content,max-content)}.novo-field-appearance-vertical[_nghost-%COMP%]{grid-template-areas:\"label\" \"input\" \"messages\";grid-template-columns:minmax(-webkit-min-content,-webkit-max-content);grid-template-columns:minmax(min-content,max-content);grid-template-rows:repeat(3,minmax(-webkit-min-content,-webkit-max-content));grid-template-rows:repeat(3,minmax(min-content,max-content));width:-webkit-min-content;width:-moz-min-content;width:min-content}[_nghost-%COMP%]   .novo-field-label[_ngcontent-%COMP%]{-ms-grid-column:1;-ms-grid-row:1;align-items:flex-end;display:grid;grid-area:label}.novo-field-appearance-underlined[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]{border-bottom:1px solid #afb9c0!important}.novo-field-appearance-underlined[_nghost-%COMP%]:not(.novo-focused):hover   .novo-field-input[_ngcontent-%COMP%]{border-bottom:1px solid #3d464d!important}.novo-field-appearance-underlined.novo-focused[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]{border-bottom:1px solid #4a89dc!important}.novo-field-appearance-underlined.novo-field-invalid[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]{border-bottom:1px solid #da4453!important}.novo-field-type-color[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]  .novo-input-element{padding:0}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]{-ms-grid-column:3;-ms-grid-row:1;display:grid;font-size:1.2rem;grid-area:input;grid-template-columns:minmax(auto,-webkit-max-content) 1fr minmax(auto,-webkit-max-content);grid-template-columns:minmax(auto,max-content) 1fr minmax(auto,max-content)}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]  .novo-input-element{background-color:transparent;background-image:none;border:none;border-bottom:none!important;box-shadow:none;padding:.4rem .2rem}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]  .novo-input-element:focus{outline:none}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]   .novo-field-infix[_ngcontent-%COMP%], [_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]   .novo-field-prefix[_ngcontent-%COMP%]{align-items:flex-end;display:flex}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]   .novo-field-infix[_ngcontent-%COMP%]   select[_ngcontent-%COMP%]{width:100%}[_nghost-%COMP%]   .novo-field-input[_ngcontent-%COMP%]   .novo-field-suffix[_ngcontent-%COMP%]{align-items:flex-end;display:flex}[_nghost-%COMP%]   .novo-field-messages[_ngcontent-%COMP%]{-ms-grid-column:3;-ms-grid-row:3;display:grid;grid-area:messages}"], changeDetection: 0 });
