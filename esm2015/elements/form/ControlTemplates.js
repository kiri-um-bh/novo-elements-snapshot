...
function NovoControlTemplates_ng_template_13_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("name", control_r180.key)("formControlName", control_r180.key)("start", control_r180.startDate)("end", control_r180.endDate)("placeholder", control_r180.placeholder)("military", control_r180.military)("weekStart", control_r180.weekStart);
    i0.ɵɵattribute("id", control_r180.key);
} }
function NovoControlTemplates_ng_template_14_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("change", function NovoControlTemplates_ng_template_14_Template_novo_address_change_1_listener($event) { i0.ɵɵrestoreView(_r193); const methods_r191 = ctx.methods; return methods_r191.handleAddressChange($event); })("focus", function NovoControlTemplates_ng_template_14_Template_novo_address_focus_1_listener($event) { i0.ɵɵrestoreView(_r193); const methods_r191 = ctx.methods; return methods_r191.handleFocus($event.event, $event.field); })("blur", function NovoControlTemplates_ng_template_14_Template_novo_address_blur_1_listener($event) { i0.ɵɵrestoreView(_r193); const methods_r191 = ctx.methods; return methods_r191.handleBlur($event.event, $event.field); })("validityChange", function NovoControlTemplates_ng_template_14_Template_novo_address_validityChange_1_listener() { const methods_r191 = ctx.methods; return methods_r191.updateValidity(); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const control_r188 = ctx.$implicit;
    const form_r189 = ctx.form;
    i0.ɵɵproperty("formGroup", form_r189);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("formControlName", control_r188.key)("config", control_r188 == null ? null : control_r188.config)("readOnly", control_r188 == null ? null : control_r188.readOnly);
} }
function NovoControlTemplates_ng_template_15_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵproperty("formGroup", form_r198);
    i0.ɵɵadvance(1);
...
function NovoControlTemplates_ng_template_16_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("onSelect", function NovoControlTemplates_ng_template_16_Template_novo_check_list_onSelect_1_listener($event) { i0.ɵɵrestoreView(_r206); const methods_r204 = ctx.methods; return methods_r204.modelChange($event); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const control_r201 = ctx.$implicit;
    const form_r202 = ctx.form;
    i0.ɵɵproperty("formGroup", form_r202);
    i0.ɵɵadvance(1);
...
function NovoControlTemplates_ng_template_17_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("change", function NovoControlTemplates_ng_template_17_Template_novo_quick_note_change_1_listener($event) { i0.ɵɵrestoreView(_r212); const methods_r210 = ctx.methods; return methods_r210.modelChange($event); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const control_r207 = ctx.$implicit;
    const form_r208 = ctx.form;
    i0.ɵɵproperty("formGroup", form_r208);
    i0.ɵɵadvance(1);
