...
export declare class MenuComponent implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<MenuComponent, "novo-menu", never, { "menuClass": "menuClass"; "autoFocus": "autoFocus"; "disabled": "disabled"; }, { "close": "close"; "open": "open"; }, ["menuItems"], never>;
}
