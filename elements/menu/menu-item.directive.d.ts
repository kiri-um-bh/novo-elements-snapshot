...
export declare class MenuItemDirective implements Highlightable {
    ...
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<MenuItemDirective, "[menuItem]", never, { "subMenu": "subMenu"; "divider": "divider"; "enabled": "enabled"; "passive": "passive"; "visible": "visible"; }, { "execute": "execute"; }, never>;
}
