...
export declare class NovoHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<NovoHeaderComponent, "novo-header,header[theme]", never, { "condensed": "condensed"; "title": "title"; "subTitle": "subTitle"; "theme": "theme"; "icon": "icon"; }, {}, never, ["novo-icon, [novo-icon]", "h1, h2, h3, h4, h5, h6, small, [novo-title], [novo-subtitle]", "section", "utils", "novo-action", "*"]>;
}
