...
export declare class NovoPickerToggleElement<T = any> implements AfterContentInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<NovoPickerToggleElement<any>, "novo-picker-toggle", ["novoPickerToggle"], { "picker": "for"; "icon": "icon"; "tabIndex": "tabIndex"; "ariaLabel": "aria-label"; "disabled": "disabled"; "disableRipple": "disableRipple"; }, {}, never, ["*"]>;
}
