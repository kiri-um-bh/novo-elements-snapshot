...
export declare class NovoInput extends NovoInputBase implements NovoFieldControl<any>, OnChanges, OnDestroy, AfterViewInit, DoCheck {
    ...
    static ɵfac: i0.ɵɵFactoryDef<NovoInput, [null, null, { optional: true; self: true; }, { optional: true; }, { optional: true; }, { optional: true; self: true; }, null, null]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<NovoInput, "input[novoInput], textarea[novoInput], select[novoInput]", never, { "disabled": "disabled"; "id": "id"; "placeholder": "placeholder"; "required": "required"; "type": "type"; "value": "value"; "readonly": "readonly"; }, {}, never>;
}
export {};
