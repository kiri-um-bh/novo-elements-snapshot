...
export declare class NovoAutocompleteElement extends NovoAutocompleteMixins implements CanDisable, AfterContentInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<NovoAutocompleteElement, "novo-autocomplete", ["novoAutocomplete"], { "tabIndex": "tabIndex"; "triggerOn": "triggerOn"; "displayWith": "displayWith"; "ariaLabel": "aria-label"; "multiple": "multiple"; "disabled": "disabled"; }, { "optionSelected": "optionSelected"; "optionActivated": "optionActivated"; }, ["optionGroups", "options"], ["*"]>;
}
export {};
