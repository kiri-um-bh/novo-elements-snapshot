...
export declare class NovoFieldElement implements AfterContentInit, OnDestroy {
    ...
    _labelElement: NovoLabelElement;
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<NovoFieldElement, "novo-field", never, { "appearance": "appearance"; "width": "width"; }, {}, ["_labelElement", "_control", "_hintElements", "_errorElements", "_prefixElements", "_suffixElements"], ["novo-label", "[novoPrefix]", "*", "[novoSuffix]", "novo-error", "novo-hint"]>;
}
